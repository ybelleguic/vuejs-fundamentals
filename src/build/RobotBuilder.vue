...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    if (this.addedToCart) {
      ...
      const response = confirm('You have to added your robot to you cart, are you sure you want to leave ?');
      next(response);
    }
  },
  ...
  methods: {
    addToCart() {
      ...
      const cost = robot.head.cost + robot.leftArm.cost + robot.torsos.cost
